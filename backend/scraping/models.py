...
class Scraper(models.Model):
    name=models.CharField(max_length=200); source=models.ForeignKey(Source,on_delete=models.PROTECT,related_name="scrapers"); method=models.CharField(max_length=40,default="static_html"); start_url=models.URLField(); active=models.BooleanField(default=True); parser_version=models.CharField(max_length=40,default="1.0.0"); created_at=models.DateTimeField(auto_now_add=True); updated_at=models.DateTimeField(auto_now=True)
